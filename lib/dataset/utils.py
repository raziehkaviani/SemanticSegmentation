...
label_colours_idd = [(128, 64, 128), (250, 170, 160), (244, 35, 232), (230, 150, 140), (220, 20, 60), (255, 0, 0),
                     (0, 0, 230), (119, 11, 32), (255, 204, 54), (0, 0, 142), (0, 0, 70), (0, 60, 100), (0, 0, 90),
                      (220, 190, 40), (102, 102, 156), (190, 153, 153), (180, 165, 180), (174, 64, 67), (220, 220, 0),
                       (250, 170, 30), (153, 153, 153), (169, 187, 214), (70, 70, 70), (150, 100, 100), (107, 142, 35),
                        (70, 130, 180), (0, 0, 0)]

mean_cityscapes = [0.485, 0.456, 0.406]
std_cityscapes = [0.229, 0.224, 0.225]
...
def decode_labels_idd(mask):
    h, w = mask.shape
    mask[mask == 255] = 26
    color_table = np.array(label_colours_idd, dtype=np.float32)
    out = np.take(color_table, mask, axis=0)
    out = out.astype(np.uint8)
    out = out[:, :, ::-1]
    return out
