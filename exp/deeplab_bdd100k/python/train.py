...
from lib.dataset.bdd100k_imgSeg import bdd100k_video_dataset, bdd100k_video_dataset_PDA
...
def train():
    ...
    net = deeplabv3plus(n_classes=19)
...
#        print('-', k)
    ...
    train_data = bdd100k_video_dataset(args.root_data_path, args.root_gt_path, args.train_list_path, crop_size=(512, 1024))
    ...
    test_data = bdd100k_video_dataset_PDA(args.root_data_path, args.root_gt_path, args.test_list_path)
