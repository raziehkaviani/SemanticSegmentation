...
python3 exp/deeplab_idd/python/test_valVideo_hrnet.py \
            ...
            --model_save_path /home/rkavian1/Desktop/videoSemSeg/BidirCurr_code/saved_model/pretrained/pretrained_idd_hrnetv2.pth \
