...
from lib.dataset.utils import transform_im_nor, randomcrop
...
def test():
    ...
    old_weight = torch.load(args.scnet_model, map_location=map_location)
    new_weight = {}
        ...
        for i, line in enumerate(lines):
            ...
            if os.path.exists(seq_path):
                ...
                for i in range(0, frames_per_video):
                    ...
                    print('-path-', path)
                    img = transform_im_nor(cv2.imread(path))
